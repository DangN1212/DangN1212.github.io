...
function setFixBackground(){
    ...
    if(valueScroll < $('#section_01').height()){
        $('#section_01 .box_inner .layer').css({
            'transform': 'translateY('+valueScroll+'px) skewY(15deg)',
            '-webkit-transform': 'translateY('+valueScroll+'px) skewY(15deg)',
            '-moz-transform': 'translateY('+valueScroll+'px) skewY(15deg)',
        })
    }
